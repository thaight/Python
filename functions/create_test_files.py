...
parser.add_argument('-o', '--output', help='Absolute path to the output folder, Ensure that it does not end with "/" for example: /home/test/project1. Note: It does not need to exist.')
